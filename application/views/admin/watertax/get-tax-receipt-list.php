        ...
        <div class="content-wrapper">
            ...
            <div class="container-xxl flex-grow-1 container-p-y">
                <h4 class="fw-bold py-3 mb-4">
                    <span class="text-muted fw-light">जल मूल्य /</span> कर रसीद प्राप्त करें
                </h4>
                <!-- Table -->
                <div class="card">
                    <div class="card-header d-flex justify-content-between align-items-center">
                        <h5 class="mb-0">जल मूल्य जमा सूची</h5>
                        ...
                        <table class="table table-hover">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <a class="btn rounded-pill btn-outline-danger" href="<?= base_url('Watertax/printReceipt/'.$value['billno']); ?>"> रसीद</a>
                                    </td>
                                </tr>
                                <?php } ?>
                            </tbody>
