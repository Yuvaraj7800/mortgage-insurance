    ...
    <div class="layout-page">
        ...
        <div class="content-wrapper">
            ...
            <div class="container-xxl flex-grow-1 container-p-y">
                ...
                <div class="card">
                    <div class="card-body">
                        <form action="<?= base_url('Watertax/updateAssesseeDetail/watertax_registrations/'.$update_detail['id']); ?>" method="POST">
                            <div class="row clearfix">
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <select name="connection_type_id" class="select2 form-select hindi" required>
                                            <?php
                                                ...
                                                foreach ($query as $key => $value) {
                                            ?>
                                            <option <?php if($row->connection_type_id == $value['connection_type_id']){ echo "selected"; } ?> value="<?= $value['connection_type_id']; ?>"><?= $value['connection_type']; ?></option>
                                            <?php } ?>
                                        </select>
                                    </div>
                                </div>
                                <div class="col-md-2">
                                    <div class="mb-3">
                                        <label class="form-label" for="">उपभोक्ता पंजी० सं०</label>
                            ...
                            <div class="row clearfix">
                                ...
                                <div class="col-md-3">
                                    <div class="mb-3">
                                        <label class="form-label" for="">वार्षिक मूल्यांकन (रू0) कर</label>
                ...
                <div class="card">
                    <div class="card-header d-flex justify-content-between align-items-center">
                        ...
                        <small class="float-end">
                            <a href="<?= base_url('Watertax/assesseeDetailWater'); ?>" class="btn btn-primary">
                                वापस जाएं
                            </a>
                        </small>
                    </div>
                        ...
                        <table class="table table-hover">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <a href="<?= base_url('Watertax/editAssesseeDetail/watertax_registrations/'.$value['id']); ?>"><i class="bx bx-edit-alt me-1"></i> Edit</a>
                                    </td>
                                </tr>
                                <?php } ?>
                            </tbody>
