...
<html lang="en">
    <head>
    	...
    	<title>नगर पालिका परिषद्, बदायूं</title>
    ...
    <body>
        ...
        <table width="100%" border="1" cellpadding="3" cellspacing="0">
            	<tr>
            	    <td colspan="2" align="center" style="font-size:40px"><b>नगर पालिका परिषद्, बदायूं उ0प्र0</b><br><span style="font-size:18px; font-weight: 600;">जल मूल्य बिल</span></td>
            	</tr>
            	<tr>
            	    ...
            	    <td colspan="2">
                	    <table width="100%" cellpadding="3">
                        	<tr>
                            	...
                            	<td width="50%">
									<?php $ward = $this->db->select('*')->from('watertax_ward')->where('ward_no', $demand->ward_no)->get()->row(); ?>
                    	...
                    	<table width="100%" border="1" cellpadding="3" cellspacing="0">
                        	...
                        	<tr>
                            	...
                            	<td align="center">जल मूल्य (वा0 मू0 - <?= $demand->arv; ?> )</td>
        ...
        <a href="<?php echo base_url().'Watertax/houseTaxDemandList'; ?>" id="printPageButton" class="btn btn-secondary footer-btn">Go Back</a>
    </body>
</html>