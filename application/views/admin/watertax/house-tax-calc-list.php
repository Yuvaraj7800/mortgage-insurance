        ...
        <div class="content-wrapper">
            ...
            <div class="container-xxl flex-grow-1 container-p-y">
                <h4 class="fw-bold py-3 mb-4">
                    <span class="text-muted fw-light">जल मूल्य /</span> कर गणना
                </h4>
                <!-- Table -->
                <div class="card">
                    <div class="card-header d-flex justify-content-between align-items-center">
                        ...
                        <small class="float-end">
                            <a href="<?= base_url('Watertax/calculateWaterTax'); ?>" class="btn btn-primary">
                                वापस जाएं
                            </a>
                        </small>
                    </div>
                    <form action="<?= base_url('Watertax/saveDemandTax'); ?>" method="POST">
                            ...
                            <table class="table table-hover">
                                ...
                                <tbody>
                                    <?php
                                        ...
                                        $billno     = $this->db->select('billno')->from('watertax_demand')->order_by('billno', 'desc')->get()->row();
                                        if(empty($billno)){ $num = 0; }else{$num=$billno->billno;}
                                        $i=0; foreach ($assesseeLists as $key => $value) {                                        
                                            $nill_arv = $this->db->get_where('watertax_registrations', ['crn'=>$value['crn']], ['fin_year' => $finYear])->result();
                                    ...
                                    <tr>
                                        ...
                                        <td><?= $value['arv'] + $value['opening_arrear'] - $value['opening_advance']; ?></td>
                                        <td>
