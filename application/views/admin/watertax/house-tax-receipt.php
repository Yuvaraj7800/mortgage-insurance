    ...
    <body>
        <div style="display: flex; padding-top:20px;">
            <table width="100%" border="1" cellpadding="3" cellspacing="0">
            	<tr>
            	    <td colspan="2" align="center" style="font-size:40px"><b>नगर पालिका परिषद्, बदायूं उ0प्र0</b><br><span style="font-size:18px; font-weight: 600;">जल मूल्य रसीद</span><br /><span>Form No. 5</span></td>
            	</tr>
            	<tr>
            	    ...
            	    <td colspan="2">
                    	...
                    	<table width="100%" border="1" cellpadding="3" cellspacing="0">
                        	...
                        	<tr>
                            	...
                            	<td align="center">कुल जल मूल्य </td>
