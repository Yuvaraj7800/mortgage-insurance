        ...
        <div class="content-wrapper">
            ...
            <div class="container-xxl flex-grow-1 container-p-y">
                <h4 class="fw-bold py-3 mb-4">
                    <span class="text-muted fw-light">जल मूल्य /</span> कर जमा करें
                </h4>
                <!-- Table -->
                <?php if(isset($row)){ ?>
                <div class="card">
                    <div class="card-body">
                        <form action="<?= base_url('Watertax/savePayment/'.$row->billno); ?>" method="POST">
                            ...
                            <a href="<?= base_url('Watertax/payHouseTaxList'); ?>" class="btn btn-secondary">Go Back</a>
                        </form>
                    </div>
                </div>
                <?php } else { ?>
                <div class="card">
                    <div class="card-header d-flex justify-content-between align-items-center">
                        ...
                        <small class="float-end">
                            <a href="<?= base_url('Watertax/payWaterTax'); ?>" class="btn btn-primary">
                                वापस जाएं
                            </a>
                        </small>
                    </div>
                        ...
                        <table class="table table-hover">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <a class="btn rounded-pill btn-outline-danger" href="<?= base_url('Watertax/payTax/'.$value['billno']); ?>"> जमा करें</a>
                                    </td>
                                </tr>
                                <?php } ?>
                            </tbody>
